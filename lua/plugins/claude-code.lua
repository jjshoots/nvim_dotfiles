local function config_function()
  require("claude-code").setup({
    ...
    keymaps = {
      toggle = {
        normal = "<M-c>",     -- Normal mode keymap for toggling Claude Code
        terminal = "<M-c>",   -- Terminal mode keymap for toggling Claude Code
        variants = {
          continue = "<M-C>",   -- New session with M-C (shift+M+c)
